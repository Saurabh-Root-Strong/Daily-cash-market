"""Accumulation / Distribution Signals page."""
...
from src.dashboard.cache.queries import cached_top_accumulation, cached_top_distribution
...
def render(selected_date: date, min_turnover: float) -> None:
    ...
    with tab1:
        ...
        **Accumulation**: Stocks with delivery ratio significantly above their 10-day average.
        ...
        """)
        acc_df = cached_top_accumulation(selected_date, min_turnover, limit=20)
        if acc_df.empty:
    ...
    with tab2:
        ...
        **Distribution**: Stocks with price up >1% but delivery ratio below average.
        ...
        """)
        dist_df = cached_top_distribution(selected_date, min_turnover, limit=20)
        if dist_df.empty:
